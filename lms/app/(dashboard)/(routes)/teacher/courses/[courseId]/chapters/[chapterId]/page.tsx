...
const ChapterIdPage = async ({ params } : { params: { courseId: string; chapterId: string } }) => {
    ...
    return (
        <>
            {
                !chapter.isPublished && (
                    <Banner variant="warning" label="This Chapter is not Published, It will not be visible to the student attending the course." />
                )
            }
            <div className="p-6">
                    ...
                    <div className="space-y-4">
                        <div>
                            <div className="flex items-center gap-x-2">
                                ...
                                <h2 className="text-xl">Chapter Customization</h2>
                            </div>
                        </div>
